...
export const youtubeEditorComponent = {
    ...
    fields: [
      {name: 'iframe', label: 'Embed Youtube Video <>', widget: 'string', hint:
`Hint: Paste a youtube video iframe into this box. To find the iframe, follow the steps below:
  ...
  5. Paste into this box.
You should now see your video appearing on the preview.`},
      {name: 'largeOnDesktop', label: 'Large size on desktop', widget: 'boolean', default: false, hint: 
'This switch controls the size of the video on a desktop screen. Switch it on if you want to make it large.\
